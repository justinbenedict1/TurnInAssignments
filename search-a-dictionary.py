...
## Print the cost.
choice_a = 'saffron'
if choice_a in flavors:
    cost = flavors[choice_a]
else:
    cost = 0
...
for choice in flavors:
    if flavors[choice] > highest_cost:
        highest_cost = flavors[choice]
        fanciest = choice
print('The fanciest flavor is {} with a cost of {}'.format(fanciest, highest_cost))