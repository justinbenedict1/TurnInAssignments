...
Cargo_max = len(cargo_hold) - 1
print(cargo_hold[Cargo_max])

cargo_hold.pop(Cargo_max)
print(cargo_hold)
...
# append and insert require arguments inside the (). Add the items 1138 and ‘20 meters’ to the list - the number at the start and the string at the end. Print the updated list to confirm the changes.
